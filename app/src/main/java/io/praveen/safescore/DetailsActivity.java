...
public class DetailsActivity extends AppCompatActivity {
    ...
    FirebaseUser mUser;
    ImageView locate;
    EditText name, home, in, out, contact, number, age;
    Button next;
    double lat, lon;
    int inh, outh;
    Intent i;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (check()){
                    ...
                    editor.putString("parent", contact.getText().toString());
                    ...
                    mUser.updateProfile(profileUpdates).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            final DatabaseReference dContact = database.child("Parent Name");
                            final DatabaseReference dMobile = database.child("Parent Mobile");
    ...
    public boolean check(){
        ...
        if (contact.getText().toString().length() == 0){
            Toast.makeText(DetailsActivity.this, "Enter Parent's name!", Toast.LENGTH_SHORT).show();
            return false;
        }
        if (number.getText().toString().length() < 10){
            Toast.makeText(DetailsActivity.this, "Enter Parent's Mobile Number!", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
